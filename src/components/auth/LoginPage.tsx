...
import { Mail, Lock, Eye, EyeOff, Activity, AlertCircle, LogIn, Github } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-300">Connect. Play. Grow.</p>
          <p className="text-sm text-slate-500 dark:text-slate-400">Welcome back to your sports network</p>
        </div>
